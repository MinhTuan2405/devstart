...
export const metadata: Metadata = {
  ...
  description:
    'Khóa học C++ miễn phí. Ngôn ngữ mạnh mẽ cho lập trình hệ thống và thi đấu lập trình.',
  keywords: ['học c++', 'c++ cơ bản', 'lập trình c++ miễn phí', 'c++ cho người mới'],
  openGraph: {
...
export default function CppCoursePage() {
  const course = getCourseWithLessons('cpp')
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:gap-8">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-3 max-w-2xl text-base leading-relaxed text-slate-600 md:text-lg">
                Ngôn ngữ mạnh mẽ cho lập trình hệ thống và thi đấu lập trình.
              </p>
      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="space-y-3">
          {course?.lessons.map((lesson, index) => (
            <LessonCard key={lesson.slug} lesson={lesson} courseSlug="cpp" index={index} />
          ))}
        </div>
