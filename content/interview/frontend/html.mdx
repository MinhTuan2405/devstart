---
title: "62 câu hỏi phỏng vấn HTML kèm đáp án ngắn gọn"
description: "Tổng hợp 62 câu hỏi phỏng vấn HTML bằng tiếng Việt kèm câu trả lời ngắn gọn, dễ ôn tập cho fresher, junior và người đi làm."
slug: "html"
category: "frontend"
topic: "HTML"
order: 3
questionCount: 62
difficulty: "Khó"
keywords: ["câu hỏi phỏng vấn html", "phỏng vấn html", "html interview", "html cho fresher", "fullstack interview html"]
...
### Thẻ và thuộc tính trong HTML là gì?
...
### Sự khác nhau của thuộc tính `id` và `class` trong phần tử HTML?
...
### Thẻ định dạng khác nhau trong HTML
...
### Các thể loại Doctypes khả dụng 
...
### Hãy giải thích cách hiển thị tập ký tự đang được sử dụng trong HTML?
...
### Sự khác nhau giữa thẻ `<strong>` và `<b>`, thẻ `<em>` và `<i>`?
...
### Đặc trưng của thẻ `<head>` và `<body>` trong HTML?
...
### Chúng ta có thể hiển thị một trang bên trong một trang web hoặc lồng các trang web vào nhau có được không?
...
### Cell Padding khác với Cell Spacing như thế nào?
...
### Làm thế nào chúng ta có thể ghép hai hoặc nhiều hàng hoặc nhiều cột thành một hàng hoặc cột duy nhất trong một bảng HTML?

HTML cung cấp hai thuộc tính cho bảng là `rowspan` và `colspan` để tạo một ô kéo dài tới nhiều hàng và cột tương ứng.

### Có thể thay đổi một phần tử inline thành một phần tử block không?

Có, có thể sử dụng thuộc tính `display` với giá trị của nó là `block`, để thay đổi phần tử inline thành phần tử block.

### Chúng ta có thể định vị một phần tử HTML bằng bao nhiêu cách?
...
### Làm sao để chỉ định liên kết trong HTML và giải thích thuộc tính `target`?
...
### Sự khác biệt giữa thẻ `<link>` và thẻ `<a>`?
...
### Cách để thêm code javascript vào HTML?
...
### Thẻ script dùng ở head hay body?
...
### Các ưu điểm của HTML5 so với các phiên bản trước?
...
### Sự khác biệt giữa thẻ img và thẻ figure?
...
### Làm thế nào để chỉ định metadata trong HTML5?
...
### Thẻ `<datalist>` và thẻ `<select>` là giống nhau?
...
### Sự khác biệt giữa thẻ `<meter>` và thẻ `<process>`?
...
### Có thể kéo và thả trong HTML5 không?
...
### Các kiểu file audio có thể dùng trong HTML5?
...
### Thông số kỹ thuật trong HTML5 là gì?
...
### Các khái niệm về web storage trong HTML5?
...
### Thẻ nào được dùng để biểu diễn kết quả tính toán? 
...
### Mối quan hệ giữa thẻ `<h1>` và `<header>` trong HTML5?
...
### Giải thích về đồ hoạ trong HTML5?
...
### Các thẻ mới cho phần tử media trong HTML5?
...
### Tại sao bạn nghĩ rằng việc bổ sung chức năng kéo và thả trong HTML5 là quan trọng? Bạn sẽ làm thế nào để tạo một hình ảnh có thể kéo được trong HTML5?
...
### Vector và Raster trong ảnh là gì?
...
### Làm thế nào để hỗ trợ SVG trên trình duyệt cũ?
...
### API định vị địa lý trong HTML5?
...
### Viết code minh hoạ API định vị địa lý?
...
## Mẹo ôn phỏng vấn HTML

- Bắt đầu với các câu hỏi định nghĩa và so sánh quan trọng trong HTML.
...
## Câu hỏi thường gặp về phỏng vấn HTML

### Nên học HTML theo thứ tự nào trước khi đi phỏng vấn?

Bạn nên học từ khái niệm nền tảng, sau đó chuyển sang câu hỏi so sánh, trường hợp sử dụng và cuối cùng là các tình huống thực tế liên quan đến HTML. Cách học này giúp bạn vừa trả lời được câu hỏi cơ bản vừa giải thích được tư duy khi làm việc thực tế.

### Làm sao trả lời tốt câu hỏi phỏng vấn HTML khi chưa có nhiều kinh nghiệm?

Hãy trả lời ngắn gọn theo cấu trúc định nghĩa, mục đích sử dụng, ưu nhược điểm và ví dụ đơn giản. Với HTML, nhà tuyển dụng thường đánh giá khả năng hiểu bản chất và cách diễn đạt rõ ràng chứ không chỉ kiểm tra việc nhớ lý thuyết.

## Tóm tắt

Bộ câu hỏi phỏng vấn HTML này giúp bạn ôn nhanh các khái niệm quan trọng, câu hỏi phổ biến và cách trả lời dễ hiểu bằng tiếng Việt. Hãy ưu tiên những phần bạn còn yếu, tự diễn giải lại bằng lời của mình và luyện thêm ví dụ thực tế để tăng sự tự tin khi phỏng vấn.
